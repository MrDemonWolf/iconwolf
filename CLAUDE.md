...
src/
  ...
  variants/
    ...
    favicon.ts      # favicon.png (48x48, rounded corners, generated by default)
    splash.ts       # splash-icon.png (1024x1024, supports --splash-input for separate source)
    android.ts      # adaptive-icon.png (foreground, default), android-icon-background.png + monochrome-icon.png (via --android)
tests/
